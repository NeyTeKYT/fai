<main>	
	...
	<form action="formulaire_dhcp.php" method="POST">
		...
		<input type="number" id="devices_number" name="devices_number" min="1" max="$max_value" value="<?php echo "$current_configured_devices_number"; ?>"><br>	<!-- Ajouter le maximum en fonction du masque de sous-réseau -->
